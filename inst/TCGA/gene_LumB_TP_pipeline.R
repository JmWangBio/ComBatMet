...
## Make sure to change the paths of the outputs to where you want to save them (lines 79, 92, and 105).
## Also, please make sure to provide the correct path to "BRCA_met.RData", the output from download_TCGA_data.R (line 22).
## This script uses multiple methods to adjust the luminal-B breast cancer gene-level methylation data for batch effects.
...
saveRDS(BRCA.gene.mat.subset.complete, 
        file = "path/to/TP_raw_gene_dat.rds")
...
saveRDS(BRCA.gene.mat.subset.complete.mcb,
        file = "path/to/TP_Mvalue_ComBat_gene_dat.rds")
...
saveRDS(BRCA.gene.mat.subset.complete.cbm, 
        file = "path/to/TP_ComBat_met_gene_dat.rds")
