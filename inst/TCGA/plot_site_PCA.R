...
## Ensure that you also provide the correct paths for "NT_raw_site_dat.rds", "NT_Mvalue_ComBat_site_dat.rds", 
## "NT_ComBat_met_site_dat.rds", "TP_raw_site_dat.rds", "TP_Mvalue_ComBat_site_dat.rds",
## and "TP_ComBat_met_site_dat.rds", which are the intermediate output files produced from 
...
## non-tumor
# NT raw data
pca.res <- prcomp(t(NT_raw_site_dat))
...
# NT M-value ComBat
pca.res <- prcomp(t(NT_Mvalue_ComBat_site_dat))
...
# NT ComBat-Met
pca.res <- prcomp(t(NT_ComBat_met_site_dat))
...
## tumor
# TP raw data
pca.res <- prcomp(t(TP_raw_site_dat))
...
# TP M-value ComBat
pca.res <- prcomp(t(TP_Mvalue_ComBat_site_dat))
...
# TP ComBat-Met
pca.res <- prcomp(t(TP_ComBat_met_site_dat))
